...
/** Top of every inner page: one h1, an optional lede and actions. */
export function PageHeader({
  ...
  return (
    <header className={cx('wrap pb-[clamp(2.5rem,2rem+2.5vw,4.5rem)] pt-[clamp(3rem,2rem+4vw,6rem)]', className)}>
